...
import watcherSaga, { getRepos } from '../saga';
...
describe('watcherSagaSaga Saga', () => {
  const watcherSagaSaga = watcherSaga();

  it('should start task to watch for LOAD_REPOS action', () => {
    const takeLatestDescriptor = watcherSagaSaga.next().value;
